...
return $this->privates['fos_user.user_provider.username'] = new \FOS\UserBundle\Security\UserProvider(($this->services['fos_user.user_manager'] ?? $this->load(__DIR__.'/getFosUser_UserManagerService.php')));
