...
$this->privates['fos_user.command.promote_user'] = $instance = new \FOS\UserBundle\Command\PromoteUserCommand(($this->privates['fos_user.util.user_manipulator'] ?? $this->load(__DIR__.'/getFosUser_Util_UserManipulatorService.php')));
