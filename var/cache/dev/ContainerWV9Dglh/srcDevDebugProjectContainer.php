...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        $this->fileMap = array(
            'App\\CoinBundle\\Controller\\CoinController' => __DIR__.'/getCoinControllerService.php',
            ...
            'lexik_jwt_authentication.encoder' => __DIR__.'/getLexikJwtAuthentication_EncoderService.php',
            'lexik_jwt_authentication.key_loader' => __DIR__.'/getLexikJwtAuthentication_KeyLoaderService.php',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('fos_user.security.implicit_login', array(0 => function () {
            return ($this->privates['fos_user.security.interactive_login_listener'] ?? $this->load(__DIR__.'/getFosUser_Security_InteractiveLoginListenerService.php'));
        }, 1 => 'onImplicitLogin'), 0);
        ...
        $instance->addListener('fos_user.registration.completed', array(0 => function () {
            return ($this->privates['fos_user.listener.authentication'] ?? $this->load(__DIR__.'/getFosUser_Listener_AuthenticationService.php'));
        }, 1 => 'authenticate'), 0);
        ...
        $instance->addListener('fos_user.change_password.edit.completed', array(0 => function () {
            return ($this->privates['fos_user.listener.flash'] ?? $this->load(__DIR__.'/getFosUser_Listener_FlashService.php'));
        }, 1 => 'addSuccessFlash'), 0);
        ...
        $instance->addListener('fos_user.resetting.reset.initialize', array(0 => function () {
            return ($this->privates['fos_user.listener.resetting'] ?? $this->load(__DIR__.'/getFosUser_Listener_ResettingService.php'));
    ...
    protected function getTranslatorService()
    {
        ...
        return $this->services['translator'] = new \Symfony\Component\Translation\LoggingTranslator(($this->privates['translator.default'] ?? $this->getTranslator_DefaultService()), $a);
    }
    ...
    protected function getTwigService()
    {
        ...
        $a->addPath(($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/views'), '!Swiftmailer');
        $a->addPath(($this->targetDirs[3].'/src/CoinBundle/Resources/views'), 'Coin');
        $a->addPath(($this->targetDirs[3].'/src/CoinBundle/Resources/views'), '!Coin');
        $a->addPath(($this->targetDirs[3].'/templates'));
    ...
    protected function getDebug_DebugHandlersListenerService()
    {
        ...
        return $this->privates['debug.debug_handlers_listener'] = new \Symfony\Component\HttpKernel\EventListener\DebugHandlersListener(NULL, $a, -1, -1, true, ($this->privates['debug.file_link_formatter'] ?? $this->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL)), true);
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'CoinBundle' => array(
                    'path' => ($this->targetDirs[3].'/src/CoinBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CoinBundle' => 'App\\CoinBundle\\CoinBundle',
            ),
