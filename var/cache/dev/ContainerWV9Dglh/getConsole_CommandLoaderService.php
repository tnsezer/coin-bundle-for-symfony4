...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\ServiceLocator(array('console.command.about' => function (): \Symfony\Bundle\FrameworkBundle\Command\AboutCommand {
    ...
    return ($this->privates['fos_user.command.activate_user'] ?? $this->load(__DIR__.'/getFosUser_Command_ActivateUserService.php'));
}, 'fos_user.command.change_password' => function (): \FOS\UserBundle\Command\ChangePasswordCommand {
    return ($this->privates['fos_user.command.change_password'] ?? $this->load(__DIR__.'/getFosUser_Command_ChangePasswordService.php'));
}, 'fos_user.command.create_user' => function (): \FOS\UserBundle\Command\CreateUserCommand {
    return ($this->privates['fos_user.command.create_user'] ?? $this->load(__DIR__.'/getFosUser_Command_CreateUserService.php'));
}, 'fos_user.command.deactivate_user' => function (): \FOS\UserBundle\Command\DeactivateUserCommand {
    return ($this->privates['fos_user.command.deactivate_user'] ?? $this->load(__DIR__.'/getFosUser_Command_DeactivateUserService.php'));
}, 'fos_user.command.demote_user' => function (): \FOS\UserBundle\Command\DemoteUserCommand {
    return ($this->privates['fos_user.command.demote_user'] ?? $this->load(__DIR__.'/getFosUser_Command_DemoteUserService.php'));
}, 'fos_user.command.promote_user' => function (): \FOS\UserBundle\Command\PromoteUserCommand {
    return ($this->privates['fos_user.command.promote_user'] ?? $this->load(__DIR__.'/getFosUser_Command_PromoteUserService.php'));
}, 'lexik_jwt_authentication.check_config_command' => function (): \Lexik\Bundle\JWTAuthenticationBundle\Command\CheckConfigCommand {
    return ($this->privates['lexik_jwt_authentication.check_config_command'] ?? $this->load(__DIR__.'/getLexikJwtAuthentication_CheckConfigCommandService.php'));
